...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? fdp.DatePickerTheme(),
  ...
  final fdp.DatePickerTheme theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    fdp.DatePickerTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(fdp.DatePickerTheme theme) {
  ...
  Widget _renderItemView(fdp.DatePickerTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(fdp.DatePickerTheme theme) {
